    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_button.setOnClickListener(v -> {
            ...
            if (!prompt.isEmpty()) {
                ...
                executor.execute(() -> {
                    String response = chatGPT("Ты классификатор в магазине. У тебя есть " +
                            "категории: электроника, бытовая техника, ремонт и строительство, одежда," +
                            " красота, автотовары, детские товары, творчество, здоровье, спорт и отдых," +
                            " продукты питания, книги, канцтовары. Определи категорию товара: " + prompt +
                            "напиши ответ одним словом").toLowerCase();
